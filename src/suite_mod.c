...
Suite *suite_mod(void) {
  ...
  tcase_add_test(tc, mod_test_4_1);
  tcase_add_test(tc, mod_test_4_2);
  tcase_add_test(tc, mod_test_4_3);
  tcase_add_test(tc, mod_test_5);
  tcase_add_test(tc, mod_test_6);
  tcase_add_test(tc, mod_test_6_1);
  tcase_add_test(tc, mod_test_6_2);
  tcase_add_test(tc, mod_test_6_3);
